...
from .local import LocalScene, Scene
...
__all__ = ["FAFBScene", "FancScene", "FlyWireScene", "HemibrainScene", "MancScene"]
...
class FAFBScene(LocalScene):
    ...
    def __init__(self):
        ...
        self.add_layers(
            SegmentationLayer(
                source="precomputed://gs://fafb-ffn1-20200412/segmentation",
        ...
        self.add_layers(
            AnnotationLayer(
                ...
                filterBySegmentation=["post_segment", "pre_segment"],
...
class FancScene(LocalScene):
    ...
    def __init__(self):
        ...
        # Add FANC layer
        self.add_layers(
            FancSegmentationLayer(segments=["648518346478550356", "648518346476465526"])
        )
...
class HemibrainScene(Scene):
    """NeuroGlancer scene containing Hemibrain data."""
    ...
    def __init__(self):
        ...
        self.add_layers(
            AnnotationLayer(
                ...
                filterBySegmentation=["post_synaptic_cell", "pre_synaptic_cell"],
                name="hemibrain:v1.2.1-synapses",
            )
        )

        # Same settings as in neuPrint
        self.state.update(
            {
                "dimensions": {"x": [8e-9, "m"], "y": [8e-9, "m"], "z": [8e-9, "m"]},
                "position": [3761, 19530, 13253],
                "crossSectionScale": 1,
                ...
                "projectionScale": 983.7572106361007,
            }
        )


class MancScene(Scene):
    """NeuroGlancer scene showing male adult nerve cord (MANC) data."""
    ...
    def __new__(self):
        return (
            ...
            .__new__(self)
            .from_url(
                "https://neuroglancer-demo.appspot.com/#!gs://flyem-user-links/short/2024-10-22.084840.490679.json"
            )
        )
